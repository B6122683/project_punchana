...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 23, 2021 at 03:55 AM
...
CREATE TABLE `users` (
  ...
  `user_type` varchar(100) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'user'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(77, 'addmin', '0963252412', 'test1@test.com', '2edd8267a9481a190cf116bef013336f', 'admin');
