...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <!-- ################################################################################################ -->
    <div class="sectiontitle">
      <h6 class="heading">โครงการสำหรับผู้สูงอายุ</h6>
      <p>ผู้สูงอายุที่ด้อยโอกาส ได้รับการพัฒนาคุณภาพชีวิต จากชุมชนและสังคมอย่างยั่งยืน</p>
    </div>
 ...
 echo "<table border='1' cellpadding='10' width=80%>";
      ...
      while($row = mysqli_fetch_array($result)) {
        ...
        echo '<td ><a href="details.php?id='.$row["id"].'"><button type="button" name="btn_add" class="btn btn-xs btn-success" style="width:100px;">ร่วมบริจาค</button></a></td>';
        echo "</tr>";
      }
      echo "</table>";
      $connect->close();
